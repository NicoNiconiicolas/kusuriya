...
"<div class='okButton' onclick='updateFulldeck(1)'>Deck Entier Hasard</div> <div class='okButton' onclick='updateFulldeck(2)'>Deck Entier Ordonné</div><br><br><div class='okButton' onclick='updateFulldeck(3)'>15 Aléatoires</div><br><br>"+
"<div id='startid'><h2>Carte de départ</h2><input id='inputid' placeholder='#1' type='text'></input> <button onclick='choosestart()'>ok</button></div><br><br>"+
