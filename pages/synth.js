...
"<div id='catalog'>"+
	...
	"<div class='bar'><p>Mayonnaise<br><br></p><p><em>requis:</em> <br>2x baies<br>parfaites</p><p><em>valeur:</em><br>300§ ~ 375§</p><p>cote: <span id='t11'>0%</span></p><img src='img/goods/red1.png' width='50px'><br><br><button onclick='synth(\"red1\")'>synthétiser</button></div>"+
	...
	"<div class='bar'><p>Lessive<br>liquide</p><p><em>requis:</em> <br>2x sac de<br>myrtilles</p><p><em>valeur:</em><br>150§ ~ 225§</p><p>cote: <span id='t23'>0%</span></p><img src='img/goods/blue3.png' width='50px'><br><br><button onclick='synth(\"blue3\")'>synthétiser</button></div>"+
	"<div class='bar'><p>Liquide de<br>refroidissement</p><p><em>requis:</em> <br>2x myrtilles<br>envoûtantes</p><p><em>valeur:</em><br>500§ ~ 600§</p><p>cote: <span id='t22'>0%</span></p><img src='img/goods/blue2.png' width='50px'><br><br><button onclick='synth(\"blue2\")'>synthétiser</button></div>"+
	"<div class='bar'><p>Eau<br>bénite</p><p><em>requis:</em> <br>2x myrtilles<br>parfaites</p><p><em>valeur:</em><br>1200§ ~ 1350§</p><p>cote: <span id='t21'>0%</span></p><img src='img/goods/blue1.png' width='50px'><br><br><button onclick='synth(\"blue1\")'>synthétiser</button></div>"+
	...
	"<div class='bar'><p>Anti-poison<br><br></p><p><em>requis:</em> <br>2x sac<br>de raisins</p><p><em>valeur:</em><br>200§ ~ 300§</p><p>cote: <span id='t33'>0%</span></p><img src='img/goods/purple3.png' width='50px'><br><br><button onclick='synth(\"purple3\")'>synthétiser</button></div>"+
	"<div class='bar'><p>Parfum<br>lavande</p><p><em>requis:</em> <br>2x raisins<br>savoureux</p><p><em>valeur:</em><br>600§ ~ 1 200§</p><p>cote: <span id='t32'>0%</span></p><img src='img/goods/purple2.png' width='50px'><br><br><button onclick='synth(\"purple2\")'>synthétiser</button></div>"+
	"<div class='bar'><p>Liqueur<br>bonbon</p><p><em>requis:</em> <br>2x raisins<br>parfaits</p><p><em>valeur:</em><br>2 500§ ~ 3 500§</p><p>cote: <span id='t31'>0%</span></p><img src='img/goods/purple1.png' width='50px'><br><br><button onclick='synth(\"purple1\")'>synthétiser</button></div>"+
"</div>"+
	"<h1>Objets spéciaux</h1>"+
	"<div id='catalog'>"+
		"<div class='bar'><p>Oeuf<br>loterie</p><p><em>coût:</em> <br>3500 §<br></p><p><em>effet:</em><br>tenter sa<br>chance à<br>la loterie</p><p>gains jusqu'à<br>7 777 §</p><img src='img/ingredients/oeuf.png' width='50px'><br><br><button onclick='oeuf()'>acheter</button></div>"+
		"<div class='bar'><p>Pot-de-vin<br><br></p><p><em>coût:</em> <br>500 §</p><p><em>effet:</em><br>Prix du marché<br>sont à nouveau<br>jetés au sort</p><br><br><img src='img/ingredients/potdevin.png' width='50px'><br><br><button onclick='reTax()'>soudoyer</button></div>"+
		"<div class='bar'><p>Secrets de<br>marchands</p><p><em>coût:</em> <br>500 §</p><p><em>effet:</em><br>Commandes du<br>jour sont<br>renouvelées</p><br><br><img src='img/ingredients/book.png' width='50px'><br><br><button onclick='reCommand()'>acheter</button></div>"+
	"</div>"+
"</div>";
showPossess();
showTax();