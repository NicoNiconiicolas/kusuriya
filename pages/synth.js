...
"<div id='catalog'>"+
	...
	"<div class='bar'><p>Limonade<br>fruitée</p><p><em>requis:</em> <br>2x sac<br>de baies</p><p><em>valeur:</em><br>10 § ~ 25 §</p><p>cote: <span id='t13'>0%</span></p><img src='img/goods/red3.png' width='50px'><br><br><button onclick='synth(\"red3\")'>synthétiser</button></div>"+
	"<div class='bar'><p>Sirop pour<br>la toux</p><p><em>requis:</em> <br>2x baies délicieuses</p><p><em>valeur:</em><br>50 § ~ 75 §</p><p>cote: <span id='t12'>0%</span></p><img src='img/goods/red2.png' width='50px'><br><br><button onclick='synth(\"red2\")'>synthétiser</button></div>"+
	"<div class='bar'><p>Mayonnaise<br><br></p><p><em>requis:</em> <br>2x baies<br>parfaites</p><p><em>valeur:</em><br>115 § ~ 225 §</p><p>cote: <span id='t11'>0%</span></p><img src='img/goods/red1.png' width='50px'><br><br><button onclick='synth(\"red1\")'>synthétiser</button></div>"+
	...
	"<div class='bar'><p>Lessive<br>liquide</p><p><em>requis:</em> <br>2x sac de<br>myrtilles</p><p><em>valeur:</em><br>33 § ~ 99 §</p><p>cote: <span id='t23'>0%</span></p><img src='img/goods/blue3.png' width='50px'><br><br><button onclick='synth(\"blue3\")'>synthétiser</button></div>"+
	"<div class='bar'><p>Liquide de<br>refroidissement</p><p><em>requis:</em> <br>2x myrtilles<br>envoûtantes</p><p><em>valeur:</em><br>150 § ~ 300 §</p><p>cote: <span id='t22'>0%</span></p><img src='img/goods/blue2.png' width='50px'><br><br><button onclick='synth(\"blue2\")'>synthétiser</button></div>"+
	"<div class='bar'><p>Eau<br>bénite</p><p><em>requis:</em> <br>2x myrtilles<br>parfaites</p><p><em>valeur:</em><br>500 § ~ 700 §</p><p>cote: <span id='t21'>0%</span></p><img src='img/goods/blue1.png' width='50px'><br><br><button onclick='synth(\"blue1\")'>synthétiser</button></div>"+
	...
	"<div class='bar'><p>Anti-poison<br><br></p><p><em>requis:</em> <br>2x <br>de raisins</p><p><em>valeur:</em><br>125 § ~ 325 §</p><p>cote: <span id='t33'>0%</span></p><img src='img/goods/purple3.png' width='50px'><br><br><button onclick='synth(\"purple3\")'>synthétiser</button></div>"+
	"<div class='bar'><p>Parfum<br>lavande</p><p><em>requis:</em> <br>2x raisins<br>savoureux</p><p><em>valeur:</em><br>333 § ~ 600 §</p><p>cote: <span id='t32'>0%</span></p><img src='img/goods/purple2.png' width='50px'><br><br><button onclick='synth(\"purple2\")'>synthétiser</button></div>"+
	"<div class='bar'><p>Liqueur<br>bonbon</p><p><em>requis:</em> <br>2x raisins<br>parfaits</p><p><em>valeur:</em><br>1 250 § ~ 2 500 §</p><p>cote: <span id='t31'>0%</span></p><img src='img/goods/purple1.png' width='50px'><br><br><button onclick='synth(\"purple1\")'>synthétiser</button></div>"+
"</div>"+
