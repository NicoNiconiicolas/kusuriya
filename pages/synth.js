...
"<div id='catalog'>"+
	...
	"<div class='bar'><p>Solution acide</p><p>requis : <br>2x myrtilles parfaites</p><p>valeur : 500$ ~ 700$</p><p>taxe: <span id='t21'>0</span> %</p><img src='img/goods/blue1.png' width='50px'><br><br><button onclick='synth(\"blue1\")'>synthétiser</button></div>"+
