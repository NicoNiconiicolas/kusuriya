...
"<div id='catalog'>"+
	...
	"<div class='bar'><p>Limonade fruitée</p><p>requis : <br>2x sac de baies</p><p>valeur : 10 § ~ 25 §</p><p>cote: <span id='t13'>0%</span></p><img src='img/goods/red3.png' width='50px'><br><br><button onclick='synth(\"red3\")'>synthétiser</button></div>"+
	"<div class='bar'><p>Sirop pour la toux</p><p>requis : <br>2x baies délicieuses</p><p>valeur : 50 § ~ 75 §</p><p>cote: <span id='t12'>0%</span></p><img src='img/goods/red2.png' width='50px'><br><br><button onclick='synth(\"red2\")'>synthétiser</button></div>"+
	"<div class='bar'><p>Mayonnaise</p><p>requis : <br>2x baies parfaites</p><p>valeur : 115 § ~ 225 §</p><p>cote: <span id='t11'>0%</span></p><img src='img/goods/red1.png' width='50px'><br><br><button onclick='synth(\"red1\")'>synthétiser</button></div>"+
	...
	"<div class='bar'><p>Lessive liquide</p><p>requis : <br>2x sac de myrtilles</p><p>valeur : 33 § ~ 99 §</p><p>cote: <span id='t23'>0%</span></p><img src='img/goods/blue3.png' width='50px'><br><br><button onclick='synth(\"blue3\")'>synthétiser</button></div>"+
	"<div class='bar'><p>Liquide de refroidissement</p><p>requis : <br>2x myrtilles envoûtantes</p><p>valeur : 150 § ~ 300 §</p><p>cote: <span id='t22'>0%</span></p><img src='img/goods/blue2.png' width='50px'><br><br><button onclick='synth(\"blue2\")'>synthétiser</button></div>"+
	"<div class='bar'><p>Eau bénite</p><p>requis : <br>2x myrtilles parfaites</p><p>valeur : 500 § ~ 700 §</p><p>cote: <span id='t21'>0%</span></p><img src='img/goods/blue1.png' width='50px'><br><br><button onclick='synth(\"blue1\")'>synthétiser</button></div>"+
	...
	"<div class='bar'><p>Anti-poison</p><p>requis : <br>2x sac deraisins</p><p>valeur : 125 § ~ 325 §</p><p>cote: <span id='t33'>0%</span></p><img src='img/goods/purple3.png' width='50px'><br><br><button onclick='synth(\"purple3\")'>synthétiser</button></div>"+
	"<div class='bar'><p>Parfum lavande</p><p>requis : <br>2x raisins savoureux</p><p>valeur : 333 § ~ 600 §</p><p>cote: <span id='t32'>0%</span></p><img src='img/goods/purple2.png' width='50px'><br><br><button onclick='synth(\"purple2\")'>synthétiser</button></div>"+
	"<div class='bar'><p>Liqueur bonbon</p><p>requis : <br>2x raisins parfaits</p><p>valeur : 1 250 § ~ 2 500 §</p><p>cote: <span id='t31'>0%</span></p><img src='img/goods/purple1.png' width='50px'><br><br><button onclick='synth(\"purple1\")'>synthétiser</button></div>"+
"</div>"+
	...
	"<div id='catalog'>"+
		...
		"<div class='bar'><p>Pot-de-vin</p><p>coût : <br>500 §</p><p>effet : Prix du marché sont <br>à nouveau jetés au sort</p><br><img src='img/ingredients/potdevin.png' width='50px'><br><br><button onclick='reTax()'>soudoyer</button></div>"+
		"<div class='bar'><p>Secrets de marchands</p><p>coût : <br>500 §</p><p>effet : Commandes du jour<br>sont renouvelées</p><br><img src='img/ingredients/book.png' width='50px'><br><br><button onclick='reCommand()'>acheter</button></div>"+
	"</div>"+
"</div>";
showPossess();
showTax();