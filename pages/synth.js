...
"<div id='catalog'>"+
	...
	"<div class='bar'><p>Limonade fruitée</p><p>requis : <br>2x baies en vrac</p><p>valeur : 10$ ~ 25$</p><img src='img/goods/red3.png' width='50px'><br><br><button onclick='synth(\"red3\")'>synthétiser</button></div>"+
	...
	"<div class='bar'><p>Lubrifiant</p><p>requis : <br>2x myrtilles en vrac</p><p>valeur : 33$ ~ 99$</p><img src='img/goods/blue3.png' width='50px'><br><br><button onclick='synth(\"blue3\")'>synthétiser</button></div>"+
