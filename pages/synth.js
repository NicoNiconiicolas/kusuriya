...
"</div>"+
	...
	"<div id='catalog'>"+
		...
		"<div class='bar'><p>Secrets de marchands</p><p>coût : <br>2 500 §</p><p>effet : Commandes du jour<br>sont renouvelées</p><br><img src='img/ingredients/book.png' width='50px'><br><br><button onclick='reCommand()'>acheter</button></div>"+
	"</div>"+
"</div>";
showPossess();
showTax();