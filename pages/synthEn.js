...
"<div id='catalog'>"+
	...
	"<div class='bar'><p>Fruity soda</p><p>required : <br>2x bag of berries</p><p>value : 10§ ~ 25§</p><p>stocks: <span id='t13'>0%</span></p><img src='img/goods/red3.png' width='50px'><br><br><button onclick='synth(\"red3\")'>synthetise</button></div>"+
	"<div class='bar'><p>Cough syrup</p><p>required : <br>2x delicious berries</p><p>value : 50§ ~ 75§</p><p>stocks: <span id='t12'>0%</span></p><img src='img/goods/red2.png' width='50px'><br><br><button onclick='synth(\"red2\")'>synthetise</button></div>"+
	"<div class='bar'><p>Mayonnaise</p><p>required : <br>2x perfect berries</p><p>value : 115§ ~ 225§</p><p>stocks: <span id='t11'>0%</span></p><img src='img/goods/red1.png' width='50px'><br><br><button onclick='synth(\"red1\")'>synthetise</button></div>"+
	...
	"<div class='bar'><p>Liquid laundry</p><p>required : <br>2x bag of blueberries</p><p>value : 33§ ~ 99§</p><p>stocks: <span id='t23'>0%</span></p><img src='img/goods/blue3.png' width='50px'><br><br><button onclick='synth(\"blue3\")'>synthetise</button></div>"+
	"<div class='bar'><p>Cooling liquid</p><p>required : <br>2x enchanting blueberries</p><p>value : 150§ ~ 300§</p><p>stocks: <span id='t22'>0%</span></p><img src='img/goods/blue2.png' width='50px'><br><br><button onclick='synth(\"blue2\")'>synthetise</button></div>"+
	"<div class='bar'><p>Holy water</p><p>required : <br>2x perfect blueberries</p><p>value : 500§ ~ 700§</p><p>stocks: <span id='t21'>0%</span></p><img src='img/goods/blue1.png' width='50px'><br><br><button onclick='synth(\"blue1\")'>synthetise</button></div>"+
	...
	"<div class='bar'><p>Anti-poison</p><p>required : <br>2x bag of grapes</p><p>value : 125§ ~ 325§</p><p>stocks: <span id='t33'>0%</span></p><img src='img/goods/purple3.png' width='50px'><br><br><button onclick='synth(\"purple3\")'>synthetise</button></div>"+
	"<div class='bar'><p>Lavender perfume</p><p>required : <br>2x succulent grapes</p><p>value : 333§ ~ 600§</p><p>stocks: <span id='t32'>0%</span></p><img src='img/goods/purple2.png' width='50px'><br><br><button onclick='synth(\"purple2\")'>synthetise</button></div>"+
	"<div class='bar'><p>Candy liquor</p><p>required : <br>2x perfect grapes</p><p>value : 1 250§ ~ 2 500§</p><p>stocks: <span id='t31'>0%</span></p><img src='img/goods/purple1.png' width='50px'><br><br><button onclick='synth(\"purple1\")'>synthetise</button></div>"+
	"</div>"+
	"<h1>Special items</h1>"+
	"<div id='catalog'>"+
		...
		"<div class='bar'><p>Bribe</p><p>price : <br>1 000 §</p><p>effect : Prices of the market<br> randomly changed</p><br><img src='img/ingredients/potdevin.png' width='50px'><br><br><button onclick='reTax()'>bribe</button></div>"+
		"<div class='bar'><p>Mercantile's secrets</p><p>price : <br>2 500 §</p><p>effect : Orders of the day<br>are renewed</p><br><img src='img/ingredients/book.png' width='50px'><br><br><button onclick='reCommand()'>buy</button></div>"+
	"</div>"+
"</div>"+
"</div>";
showPossess();