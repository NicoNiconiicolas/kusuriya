...
"<div id='catalog'>"+
	...
	"<div class='bar'><p>Mayonnaise<br><br></p><p><em>required:</em> <br>2x perfect<br>berries</p><p><em>value:</em><br>150§ ~ 225§</p><p>stocks: <span id='t11'>0%</span></p><img src='img/goods/red1.png' width='50px'><br><br><button onclick='synth(\"red1\")'>synthetise</button></div>"+
	...
	"<div class='bar'><p>Liquid<br>laundry</p><p><em>required:</em> <br>2x bag<br>of blueberries</p><p><em>value:</em><br>100§ ~ 150§</p><p>stocks: <span id='t23'>0%</span></p><img src='img/goods/blue3.png' width='50px'><br><br><button onclick='synth(\"blue3\")'>synthetise</button></div>"+
	"<div class='bar'><p>Cooling<br>liquid</p><p><em>required:</em> <br>2x enchanting<br>blueberries</p><p><em>value:</em><br>225§ ~ 325§</p><p>stocks: <span id='t22'>0%</span></p><img src='img/goods/blue2.png' width='50px'><br><br><button onclick='synth(\"blue2\")'>synthetise</button></div>"+
	"<div class='bar'><p>Holy<br>water</p><p><em>required:</em> <br>2x perfect<br>blueberries</p><p><em>value:</em><br>325§ ~ 525§</p><p>stocks: <span id='t21'>0%</span></p><img src='img/goods/blue1.png' width='50px'><br><br><button onclick='synth(\"blue1\")'>synthetise</button></div>"+
	...
	"<div class='bar'><p>Anti-poison<br><br></p><p><em>required:</em> <br>2x bag of<br>grapes</p><p><em>value:</em><br>400§ ~ 800§</p><p>stocks: <span id='t33'>0%</span></p><img src='img/goods/purple3.png' width='50px'><br><br><button onclick='synth(\"purple3\")'>synthetise</button></div>"+
	"<div class='bar'><p>Lavender<br>perfume</p><p><em>required:</em> <br>2x succulent<br>grapes</p><p><em>value:</em><br>800§ ~ 1 600§</p><p>stocks: <span id='t32'>0%</span></p><img src='img/goods/purple2.png' width='50px'><br><br><button onclick='synth(\"purple2\")'>synthetise</button></div>"+
	"<div class='bar'><p>Candy<br>liquor</p><p><em>required:</em> <br>2x perfect<br>grapes</p><p><em>value:</em><br>1 600§ ~ 3 500§</p><p>stocks: <span id='t31'>0%</span></p><img src='img/goods/purple1.png' width='50px'><br><br><button onclick='synth(\"purple1\")'>synthetise</button></div>"+
	"</div>"+
	"<h1>Special items</h1>"+
	"<div id='catalog'>"+
