...
"<div id='catalog'>"+
	...
	"<div id='catalog'>"+
		...
		"<div class='bar'><p>Mercantile's secrets</p><p>price : <br>500 §</p><p>effect : Orders of the day<br>are renewed</p><br><img src='img/ingredients/book.png' width='50px'><br><br><button onclick='reCommand()'>buy</button></div>"+
	"</div>"+
"</div>"+
"</div>";
showPossess();
